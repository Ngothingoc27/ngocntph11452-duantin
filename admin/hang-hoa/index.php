...
if(exist_param("btn_insert")){
    ...
    try {
        hang_hoa_insert($ten_hh, $don_gia, $giam_gia, $hinh, $ma_loai, $dac_biet, $so_luot_xem, $ngay_nhap, $mo_ta, $ma_giam_gia, $ky_gui);
        unset($ten_hh, $don_gia, $giam_gia, $hinh, $ma_loai, $dac_biet, $so_luot_xem, $ngay_nhap, $mo_ta, $ma_giam_gia, $ky_gui);
    ...
    try {
        hang_hoa_update($ma_hh, $ten_hh, $don_gia, $giam_gia, $ma_giam_gia, $hinh, $ma_loai, $dac_biet, $ky_gui, $so_luot_xem, $ngay_nhap, $mo_ta);
        $MESSAGE = "Cập nhật ok";
    } 
    catch (Exception $exc) {
        echo $exc->getMessage();
