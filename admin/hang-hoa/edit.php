        ...
        <form action="index.php" method="post" enctype="multipart/form-data">
            ...
            <div>
                ...
                <div>
                    ...
                    <input name="ma_giam_gia" value="<?=$ma_giam_gia?>">
                </div>
                <div>
            ...
            <div>
                ...
                <div>
                    ...
                    <div>
                        <label><input name="ky_gui" value="2" type="radio" <?=$ky_gui?'':'checked'?>>Ký gửi</label>
                        <label><input name="ky_gui" value="1" type="radio"<?=$ky_gui?'checked':''?>>Bình thường</label>
                    </div>
                </div>
